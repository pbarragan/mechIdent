...
#fileName = 'data/data0Thu_Apr_17_13_43_22_2014.txt' # entropy
#fileName = 'data/data0Thu_Apr_17_13_48_04_2014.txt' # OG

#fileName = 'data/data0Thu_Apr_17_14_01_17_2014.txt' # OG larger var
fileName = 'data/data0Thu_Apr_17_14_14_55_2014.txt' # OG larger var
...
models = ["Free","Fixed","Rev","Pris","L1","L2","Rev2","Pris2","L12","L22"]
for i in range(numMPPairs):
    pyplot.plot(inds,totalData[i,:],'-o')

pyplot.title(models[model]+' - Entropy')
